...
class TestWaypointActionServer(unittest.TestCase):
    ...
    def test_position(self):
        ...
        self.assertAlmostEqual(self.current_position.x, self.target_x, delta=self.tolerance)
        self.assertAlmostEqual(self.current_position.y, self.target_y, delta=self.tolerance)
    ...
    def test_rotation(self):
        ...
        self.assertAlmostEqual(self.current_yaw, expected_yaw, delta=self.tolerance)

if __name__ == '__main__':
    import rostest
    rostest.rosrun('tortoisebot_waypoints', 'test_waypoint_action_server', TestWaypointActionServer)